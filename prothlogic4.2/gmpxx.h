...
inline unsigned long __gmpxx_abs_ui (mpir_si l)
{
...
struct __gmp_binary_plus
{
  ...
  static void eval(mpz_ptr z, mpz_srcptr w, unsigned long l)
  {
  ...
  static void eval(mpz_ptr z, unsigned long l, mpz_srcptr w)
  { eval(z, w, l); }
  ...
  static void eval(mpq_ptr q, mpq_srcptr r, unsigned long l)
  {
    if (__GMPXX_CONSTANT(l) && l == 0)
    {
      if (q != r) mpq_set(q, r);
  ...
  static void eval(mpq_ptr q, unsigned long l, mpq_srcptr r)
  { eval(q, r, l); }
  ...
  static void eval(mpf_ptr f, mpf_srcptr g, unsigned long l)
  { mpf_add_ui(f, g, l); }
  static void eval(mpf_ptr f, unsigned long l, mpf_srcptr g)
  { mpf_add_ui(f, g, l); }
...
struct __gmp_binary_equal
{
  ...
  static bool eval(mpz_srcptr z, unsigned long l)
  { return mpz_cmp_ui(z, l) == 0; }
  static bool eval(unsigned long l, mpz_srcptr z)
  { return mpz_cmp_ui(z, l) == 0; }
  ...
  static bool eval(mpq_srcptr q, unsigned long l)
  { return mpq_cmp_ui(q, l, 1) == 0; }
  static bool eval(unsigned long l, mpq_srcptr q)
  { return mpq_cmp_ui(q, l, 1) == 0; }
  ...
  static bool eval(mpf_srcptr f, unsigned long l)
  { return mpf_cmp_ui(f, l) == 0; }
  static bool eval(unsigned long l, mpf_srcptr f)
  { return mpf_cmp_ui(f, l) == 0; }
...
struct __gmp_cmp_function
{
  ...
  static int eval(mpz_srcptr z, unsigned long l)
  { return mpz_cmp_ui(z, l); }
  static int eval(unsigned long l, mpz_srcptr z)
  { return -mpz_cmp_ui(z, l); }
  ...
  static int eval(mpq_srcptr q, unsigned long l)
  { return mpq_cmp_ui(q, l, 1); }
  static int eval(unsigned long l, mpq_srcptr q)
  { return -mpq_cmp_ui(q, l, 1); }
  ...
  static int eval(mpf_srcptr f, unsigned long l)
  { return mpf_cmp_ui(f, l); }
  static int eval(unsigned long l, mpf_srcptr f)
  { return -mpf_cmp_ui(f, l); }
...
public:
  ...
  __gmp_expr(unsigned long long int  l) { mpz_init_set_ui(mp, static_cast<unsigned long>(l)); }
#endif
...
__gmp_expr & operator=(unsigned int i) { mpz_set_ui(mp, i); return *this; }
  ...
  __gmp_expr & operator=(unsigned long long int i) { mpz_set_ui(mp, static_cast<unsigned long>(i)); return *this; }
#endif
  ...
  unsigned long get_ui() const { return mpz_get_ui(mp); }
...
public:
  ...
  __gmp_expr(unsigned long long int l) { mpq_init(mp); mpq_set_ui(mp, static_cast<unsigned long>(l), 1); }
#endif
  ...
  { mpq_set_ui(mp, static_cast<unsigned long>(l), 1); return *this; }
#endif
...
public:
  ...
  __gmp_expr(unsigned long long int s) { mpf_init_set_ui(mp, static_cast<unsigned long>(s)); }
  __gmp_expr(unsigned long long int s, mp_bitcnt_t prec)
  { mpf_init2(mp, prec); mpf_set_ui(mp, static_cast<unsigned long>(s)); }
#endif
  ...
  __gmp_expr & operator=(unsigned long long int l)
  { mpf_set_ui(mp, static_cast<unsigned long>(l)); return *this; }
#endif
  ...
  unsigned long get_ui() const { return mpf_get_ui(mp); }
...
__GMPNN_DEFINE_BINARY_FUNCTION(fun, eval_fun, type, unsigned long)
...
{                                                                      \
  return __gmp_expr<T, __gmp_binary_expr                               \
    <__gmp_expr<T, U>, unsigned long, eval_fun> >(expr, l);                   \
}
...
#define __GMP_DEFINE_COMPOUND_OPERATOR_UI(type, fun, eval_fun)  \
                                                                \
inline type##_class & type##_class::fun(unsigned long l)               \
{                                                               \
  __gmp_set_expr(mp, __gmp_expr<type##_t, __gmp_binary_expr     \
    <type##_class, unsigned long, eval_fun> >(*this, l));              \
  return *this;                                                 \
}
...
extern "C" {
  ...
  typedef void __gmp_randinit_lc_2exp_t (gmp_randstate_t, mpz_srcptr, unsigned long, mp_bitcnt_t);
...
public:
  ...
  gmp_randclass(__gmp_randinit_lc_2exp_t* f,
		mpz_class z, unsigned long l1, mp_bitcnt_t l2)
  ...
  void seed(unsigned long s) { gmp_randseed_ui(state, s); }
